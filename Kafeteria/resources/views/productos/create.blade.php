        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="peso" name="peso" value="{{ $producto->peso }}" step="0.01" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="fecha_de_creacion" name="fecha_de_creacion" value="{{ $producto->fecha_de_creacion }}" required>
                </div>
            </div>
        </div>
